...
@Component({
    standalone: true,
    selector: 'app-estatisticas-system',
    ...
    <div class="card mb-0">
        <div class="flex justify-between mb-4">
            <div>
                <span class="block text-muted-color font-medium mb-4">Quiosques</span>
                <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">Qtd: {{ dashboardSystemModel.qtdTotQuiosque
                    }}</div>
            </div>
...
export class EstatisticasSystemComponent {
